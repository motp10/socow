...
TEST_CASE("Access front/back element") {
  ...
  SECTION("const") {
    const ct::SocowVector<Element, 3>& ca = a;
...
TEST_CASE("Move constructor") {
  ...
  ct::SocowVector<Element, 3> b = std::move(a);
...
TEST_CASE("Insert") {
  ...
  ct::SocowVector<Element, 3>::ConstIterator it = a.insert(a.begin() + K, 42);
